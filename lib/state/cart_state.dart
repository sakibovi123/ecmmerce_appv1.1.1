...
class CartState with ChangeNotifier {
  ...
  Future<void> getoldOrders() async {
    // String url = 'https://gngbd.com/api/order/';
  ...
  Future<void> addtoCart(int id) async {
    // String url = 'https://gngbd.com/api/addtocart/';
  ...
  Future<void> deletecartproduct(int id) async {
    // String url = 'https://gngbd.com/api/delatecartprod/';
  ...
  Future<bool> deletecart(int id) async {
    // String url = 'https://gngbd.com/api/deletecart/';
  ...
  Future<bool> ordercart(
    ...
    // String url = 'https://gngbd.com/api/ordernow/';
