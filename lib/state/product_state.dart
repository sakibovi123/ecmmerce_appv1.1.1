...
class ProductState with ChangeNotifier {
  ...
  Future<bool> getProducts() async {
    // String url = 'https://gngbd.com/api/products/';
    var url = Uri.parse('https://sdp4.pythonanywhere.com/api/products/');
  ...
  Future<void> favoritButton(int id) async {
    ...
    var url = Uri.parse('https://sdp4.pythonanywhere.com/api/favorit/');
    var token = storage.getItem('token');
